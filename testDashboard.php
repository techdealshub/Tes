...
function editNode(button){
    ...
    //
    // مهم:
    // نتحقق من treeClose قبل addEventListener
    // =================================================
    ...
    function highlightTag(tag){
        ...
        // تحديد كل العناصر التي لها نفس التاج
        treeContainer
            .querySelectorAll(".tree-tag")
            .forEach(item => {
...
// =====================================================
// إنشاء اسم فريد للعنصر
// لا يغير class أو id الأصلي
// =====================================================

function getLiveName(element){

    if(!element.hasAttribute("data-live-name")){

        if(!window.liveElementCounter){
            window.liveElementCounter = 0;
        }

        window.liveElementCounter++;

        element.setAttribute(
            "data-live-name",
            "data-name" + window.liveElementCounter
        );
    }
...
// =====================================================
// Selector خاص بالعنصر المحدد فقط
// =====================================================
...
function highlightElement(element){
    ...
    // =================================================
    // إنشاء Selector للعنصر الذي ضغطنا عليه
    // =================================================
    ...
    if(selectedClass){
        ...
        if(
            ...
            for(
                ...
                const priority =
                    inlineStyle.getPropertyPriority(
                        property
                    );

...
function findActualImagePath(
     ...
     * or otherwise alter a full/relative path supplied by the user.
     */
    $value = trim($value);
...
if (
    ...
    /*
     * ============================================================
     * CLEAR ONLY HOME / REVIEWS / COMPARE LINKS
     * ============================================================
     *
     * These labels are intentionally left with an empty href.
     * No other href is changed.
     */

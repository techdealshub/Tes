...
function updateReviewsData(
     ...
     * Support:
     * 1. JSON
     * 2. PHP returning an array
     * 3. PHP outputting JSON
     */
    ...
    if (is_file($dataPath)) {
        ...
        if (
            ...
            if (
                ...
                $reviews =
                    $decodedOutput['reviews'];
            }
        }
    }

    /*
     * REPLACE AN EXISTING REVIEW WITH THE SAME URL.
     * Otherwise append the new review.
     */
    ...
    /*
     * DUAL-MODE reviews-data.php:
     *
     * - include() returns the array to PHP.
     * - Direct browser/fetch access returns JSON.
     */

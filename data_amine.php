...
function updateFeaturedReviewsHtml(): bool
{
     ...
     *
     * IMPORTANT:
     * Existing card HREF is NOT changed here.
     *
     * This protects existing card links.
     * ============================================================ */
    ...
    /* ============================================================
     * CAPTURE SECTION-SPECIFIC TEMPLATES
     *
     * THIS IS THE IMPORTANT FIX.
     *
     * Every section gets its own HTML structure.
     * ============================================================ */
    ...
    foreach (
        ...
        $cards =
            $matches[0] ?? [];
                ...
                /*
         * A section may intentionally have no cards yet.
         * Do NOT fail the whole update.
         *
         * The Featured Reviews card is used as a structural
         * fallback template for an empty section.
         */
        if (empty($cards)) {
            continue;
        }
        ...
        /*
         * Featured Reviews has a special MAIN card.
         */
        if ($sectionId === 'featured-reviews') {
            ...
            foreach ($cards as $candidate) {
                ...
                if (
                    ...
                    $sectionTemplates[$sectionId]['main'] =
                        $candidate;
                    break;
                }
            }
      ...
      /*
     * ============================================================
     * FALLBACK TEMPLATE FOR EMPTY SECTIONS
     * ============================================================
     *
     * more-featured may start empty intentionally.
     * Do not fail the whole Featured Reviews update.
     *
     * Use the original Featured Reviews card structure as the
     * fallback only when a section has no card of its own.
     */
    if (
        isset($sectionTemplates['featured-reviews']['normal'])
    ) {

        if (
            !isset($sectionTemplates['more-featured'])
        ) {
            $sectionTemplates['more-featured'] = [
                'normal' =>
                    $sectionTemplates['featured-reviews']['normal'],
                'main' =>
                    $sectionTemplates['featured-reviews']['normal']
            ];
        }
        ...
        if (
            !isset($sectionTemplates['editors-picks'])
        ) {
            $sectionTemplates['editors-picks'] = [
                'normal' =>
                    $sectionTemplates['featured-reviews']['normal'],
                'main' =>
                    $sectionTemplates['featured-reviews']['normal']
    ...
    /*
     * We must have the three section templates.
     */
    if (
        !isset($sectionTemplates['featured-reviews']) ||
        !isset($sectionTemplates['more-featured']) ||
        !isset($sectionTemplates['editors-picks'])
    ) {
        return false;
    ...
    /* ============================================================
     * BUILD NEW CARD FROM THE CORRECT SECTION TEMPLATE
     * ============================================================ */

    $buildReviewCardFromTemplate = static function (
        string $template,
        array $review,
        bool $mainReview = false
    ) use (
        $escape,
        $scoreToCardRating,
        $buildCardImage,
    ...
    /* ============================================================
     * UPDATE EXISTING REVIEW CARDS
     *
     * Only review-card elements are touched.
     * Navigation/header/footer links are untouched.
     * ============================================================ */
    ...
    $reconcileReviewSection = static function (
        ...
        /*
         * Existing cards indexed by title.
         */
        $existingCards = [];
        ...
        /*
         * Remove all existing review cards.
         * Everything else inside the grid remains untouched.
         */
        $remainingInside =
            preg_replace(
                $cardPattern,
        ...
        foreach ($phones as $phone) {
            ...
            /*
             * Existing card:
             * keep its complete HTML structure.
             */
            if (
                isset(
                    $existingCards[$key]
        ...
        /*
         * Preserve non-card content.
         */
        $newInside =
            $cardsOutput .
            ltrim($remainingInside);
        ...
        array_values(
            array_filter(
                ...
                static function (
                    ...
                    return
                        (float)$phone['rating'] >= 4.7;
                }
            )
        );

    /*
     * 4. FEATURED PHONE SCORES
     * EXACTLY TOP 5
     */
    $featuredScorePhones =
        array_slice(
    ...
    $updateScoreItem = static function (
        ...
        /*
         * Existing score-item HREF is intentionally preserved.
         */
    ...
    if ($scoreSectionInfo !== null) {
        ...
        if (
            ...
            if ($scoreListEnd !== null) {
                ...
                /*
                 * Use the original first score item
                 * as the score section's structural template.
                 */
                $scoreTemplate = '';
                ...
                if ($scoreTemplate !== '') {
                    ...
                    foreach (
                        ...
                        if (
                            ...
                            /*
                             * New score item gets the
                             * prepared URL only here.
                             */
                            $url =
                                $getReviewUrl(
                                    $phone['review']

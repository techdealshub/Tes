...
function findActualImagePath(
    ...
    /*
     * IMAGE PATH IS GENERATED AUTOMATICALLY.
     * The value entered in the image field is ignored.
     */

    $brandDirectory =
        findBrandDirectory($brand);
...
function fixEmptyImageSources(
    ...
    foreach ($containers as $className => $field) {
        ...
        /*
         * Find the container having the image class,
         * then fill ONLY an empty src inside it.
         *
        ...
        $pattern =
            ...
            . '[^>]*>'
            . '.*?'
            . '</(?:div|section|figure|article|span)>)~isu';
            ...
            preg_replace_callback(
                ...
                static function (array $match) use ($value): string {
                    ...
                    $container =
                        preg_replace_callback(
                            '~(\bsrc\s*=\s*)(["\'])\s*\2~iu',
                            static function (array $srcMatch) use ($value): string {
